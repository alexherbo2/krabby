function Krabby({ dormant = true } = {}) {
  ...
  krabby.modes.modal.enable('Video', 'Image', 'Link', 'Document', 'Text', 'Command')
  ...
  // Reload pages
  krabby.modes.modal.map('Command', ['KeyR'], () => location.reload(), 'Reload the page', 'Reload pages')
  krabby.modes.modal.map('Command', ['Shift', 'KeyR'], () => location.reload(true), 'Reload the page, ignoring cached content', 'Reload pages')
